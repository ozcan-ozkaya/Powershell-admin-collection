...
configuration BuildDomainController
{
    ...
    Node localhost
    {
        ...
        xDnsServerADZone addReverseADZone3Net {
        ...
        xDnsServerADZone addReverseADZone4Net {
        ...
        xDnsServerADZone addReverseADZone5Net {
...
$ConfigData = @{
    AllNodes = @(
        @{
            Nodename = "localhost"
            ThisComputerName = "otherdc"
            IPAddress = "192.168.3.12/24"
            DnsAddress = "192.168.3.12"
            GatewayAddress = "192.168.3.2"
            InterfaceAlias = "Ethernet0"
            DomainName = "othercompany.pri"
            DomainDN = "DC=OtherCompany,DC=Pri"
